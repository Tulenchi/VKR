<template>
  <div class="navbar bg-primary shadow-sm">
    ...
    <div class="navbar-center">
      <a class="text-2xl text-primary-content">Изменение конфигурации</a>
    </div>
  ...
  <ConfirmBigDeleteModal
      :modalBigId="'big-delete-conf-' + form.id"
      customDataTip="Удаление конфигурации"
      customMessage="Вы точно хотите удалить эту конфигурацию?"
  />
...
useSeoMeta({
  ...
  ogTitle: 'Изменение конфигурации',
