<template>
  <div class="navbar bg-primary shadow-sm">
    ...
    <div class="navbar-center">
      <a class="text-2xl text-primary-content">Добавление IP-адреса</a>
    </div>
  ...
  <div class="delete">
    <button class="btn btn-xl btn-square bg-neutral-50 text-neutral-50-content shadow-md" @click="showPopup">
