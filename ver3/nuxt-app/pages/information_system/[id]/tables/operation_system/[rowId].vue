<template>
  <div class="navbar bg-primary shadow-sm">
    ...
    <div class="navbar-center">
      <a class="text-2xl text-primary-content">Изменение операционной системы</a>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="mb-2">
          <div class="flex items-center justify-between mb-2">
            <h3 class="text-xl font-semibold">Операционная система</h3>
          </div>
        </div>
  ...
  <ConfirmBigDeleteModal
      :modalBigId="'big-delete-op-' + form.id"
      customDataTip="Удаление операционной системы"
      customMessage="Вы точно хотите удалить эту операционную систему?"
  />
...
useSeoMeta({
  title: 'Изменение операционной системы',
  ogTitle: 'Изменение операционной системы',
